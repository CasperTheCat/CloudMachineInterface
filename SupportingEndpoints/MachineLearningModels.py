...
ins, outs, tests, rawins = MakeData(30000,55,dilation, seqLength, 35, disturb)
yins, youts, ytest, rawyins = MakeData(15000,45,dilation, seqLength, 21, disturb)
...
print(rawins[1:].shape)

predmodel.fit(ins, outs, validation_data=(yins, youts), batch_size=16, epochs=epochlies * 2)
...
for i in range(yins.shape[0] // 2):
    ytest = numpy.expand_dims(yins[i], 0)
