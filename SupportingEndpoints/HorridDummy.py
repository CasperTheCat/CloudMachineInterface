...
inFeed, targetStates = Utils.ShuffleTogether(inFeed, targetStates)
...
predmodel.fit(inFeed, targetStates, validation_data=(inVal, val_targetStates), batch_size=8, epochs=epochlies)
